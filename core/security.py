...
def create_refresh_token(user_id: int) -> str:
    ...
    payload = {"sub": str(user_id), "token_type": "refresh", "exp": expire}
...
def create_reset_token(user_id: int) -> str:
    ...
    payload = {"sub": str(user_id), "token_type": "reset", "purpose": "reset", "exp": expire}
...
def get_current_user_id(credentials: HTTPAuthorizationCredentials = Depends(bearer_scheme)) -> int:
    ...
    # (this alone now also rejects reset tokens, since their token_type is "reset", not "access")
